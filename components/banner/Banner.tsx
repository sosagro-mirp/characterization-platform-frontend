        ...
        <div>
            <div className='lg:flex'>
                <div className="lg:w-[50%] 2xl:w-[60%] px-6 lg:pl-32 2xl:pl-64 lg:py-32 ">
                    ...
                    <Link href="/#proyecto" className="w-full md:max-w-max mt-6 bg-green-400 py-3 px-6 rounded-lg text-sm font-bold hover:bg-green-500 transition-colors md:mr-4 inline-block text-center">Conocer el proyecto</Link>
